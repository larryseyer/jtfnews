...
- Copy `data/monitor.json` to `docs/data/monitor.json`
...
<iframe src="https://github.com/sponsors/JTFNews/card" ...></iframe>
```
...
## Phase 3: Full Monitor Page (docs/monitor.html)
...
### 3.2 Files
- `docs/monitor.html` (~80 lines)
- `docs/monitor.css` (~200 lines)
- `docs/monitor.js` (~250 lines)
...
| `docs/index.html` | Modify | Add Live Operating Costs widget |
| `docs/monitor.html` | Create | Full dashboard page |
| `docs/monitor.css` | Create | Dashboard styles |
| `docs/monitor.js` | Create | Dashboard logic |
| `docs/data/monitor.json` | Create (auto) | Synced each cycle |
