...
- Synced to `docs/interest.json` for public dashboard
...
| `docs/` website | Add `/progress` and `/interest` pages |
...
| File | Purpose |
|------|---------|
| `docs/progress.html` | Public funding/interest dashboard |
| `docs/interest.html` | Interest indication form |
| `docs/js/progress.js` | Dashboard logic |
| `docs/js/interest.js` | Interest form logic |
...
| File | Changes |
|------|---------|
| `docs/progress.html` | New: funding/interest dashboard |
| `docs/interest.html` | New: interest indication form |
| `docs/js/progress.js` | New: dashboard rendering logic |
| `docs/js/interest.js` | New: form submission + GitHub OAuth |
