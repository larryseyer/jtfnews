...
2. Exports an async function postToBluesky(text, link) that:
   ...
   - Includes a link facet pointing to the full story on jtfnews.org
...
2. Generates a valid podcast RSS 2.0 XML feed with:
   ...
   - Channel link: https://jtfnews.org/
...
# Podcast
PODCAST_AUDIO_BASE_URL=https://jtfnews.org/audio/
```
