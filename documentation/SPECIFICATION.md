...
|---------|------------|---------|
| "JTF News is supported by viewers like you." | Support · github.com/sponsors/JTFNews | Financial support |
  ...
  "messages": [
    {
      ...
      "source_text": "Support · github.com/sponsors/JTFNews"
    },
    {
...
• Screensaver: https://jtfnews.org/screensaver-setup.html
• Transparency: https://jtfnews.org/
• RSS Feed: https://jtfnews.org/feed.xml
• Source Code: https://github.com/JTFNews/jtfnews
• Support: https://github.com/sponsors/JTFNews
...
**Sync Mechanism:** `main.py` pushes `monitor.json` and `stories.json` to GitHub via API after each cycle for live dashboard updates.
...
# Archive.org Podcast Hosting (REQUIRED)
...
**Implementation:**
- Corrections file: `data/corrections.json` (local) and `docs/corrections.json` (public)
