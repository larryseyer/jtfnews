...
| Task | Files | Priority |
|------|-------|----------|
| 4. Create interest form page | `gh-pages-dist/interest.html` | High |
| 5. Implement GitHub OAuth flow | `gh-pages-dist/js/interest.js` | High |
| 6. Implement email verification fallback | `gh-pages-dist/js/interest.js` | Medium |
| 7. Create region selection UI (hierarchical) | `gh-pages-dist/js/interest.js` | High |
...
| Task | Files | Priority |
|------|-------|----------|
| 9. Create progress dashboard page | `gh-pages-dist/progress.html` | High |
| 10. Implement funding progress bars | `gh-pages-dist/js/progress.js` | High |
| 11. Implement interest percentage display | `gh-pages-dist/js/progress.js` | High |
| 12. Implement deployment queue view | `gh-pages-dist/js/progress.js` | Medium |
| 13. Style dashboard (match JTF aesthetic) | `gh-pages-dist/css/progress.css` | Medium |
...
| 16. Add progress link to index.html | `gh-pages-dist/index.html` | Low |
...
| `gh-pages-dist/index.html` | Existing website structure |
